...
export const caseStudiesFaqs = [
  ...
  { question: 'Do you work with small businesses?', answer: 'Yes. Our Starter plan is built for smaller teams. Case studies often feature larger accounts, but the same AI and workflows apply at every scale.' },
...
export const integrationsFaqs = [
  { question: 'How do I connect my ad accounts?', answer: 'Use OAuth for Google, Meta, and OTAs — no CSV imports. You sign in with your existing credentials; we request read and optional write access. Setup usually takes under 15 minutes.' },
  { question: 'Is there an API for custom integrations?', answer: 'Yes. Professional and Enterprise plans include REST API access for custom connections to your CRM, BI tools, or internal systems. See our API docs or contact us for details.' },
  ...
  { question: 'Do you support TikTok Ads?', answer: 'Yes. TikTok Ads is supported alongside Google, Meta, and OTAs. Connect it from the Integrations area in your account.' },
  { question: 'Can I connect multiple Google or Meta accounts?', answer: 'Yes. Your plan limits how many ad accounts you can connect (e.g. Starter 2, Professional 10, Enterprise unlimited). Each account is connected via OAuth.' },
  ...
  { question: 'What about CRM or PMS integrations?', answer: 'Professional and Enterprise plans include API access so you can build or use pre-built connectors to your CRM or property management system.' },
...
export const knowledgeBaseFaqs = [
  ...
  { question: 'Can I export my data?', answer: 'Yes. Use reporting and export options in the dashboard. API access on Professional and Enterprise also lets you pull data into your own systems.' },
];
